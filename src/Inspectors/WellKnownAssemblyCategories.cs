...
namespace NDifference.Inspectors
{
	public static class WellKnownAssemblyCategories
	{
		...
		public static readonly Category UnchangedAssemblies = new Category { Name = "Changed Assemblies", Description = "These assemblies have not changed between the two versions of the product", Priority = new CategoryPriority(4) };
