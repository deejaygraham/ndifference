...
namespace NDifference.UnitTests
{
	public class ICombinedTypesFacts
	{
		...
		public void CombinedTypes_BuildFrom_Identical_Lists_All_Pairs_Are_Matched()
		{
            ...
            { 
                new PocoType { Access = AccessModifier.Public, FullName = "Example.First", Name = "First", Namespace = "Example", Taxonomy = TypeTaxonomy.Class },
			    new PocoType { Access = AccessModifier.Public, FullName = "Example.Second", Name = "Second", Namespace = "Example", Taxonomy = TypeTaxonomy.Class },
			    new PocoType { Access = AccessModifier.Public, FullName = "Example.Third", Name = "Third", Namespace = "Example", Taxonomy = TypeTaxonomy.Class }
            };
